          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
              ...
              >
                ...
                {totalItems > 0 && (
                  <span className="absolute top-1.5 right-1.5 inline-flex items-center justify-center w-5 h-5 text-xs font-bold leading-none text-red transform translate-x-1/2 -translate-y-1/2  dark:bg-primary-500 rounded-full">
                    {totalItems}
                  </span>
                )}
