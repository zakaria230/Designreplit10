  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about DesignKorv's privacy practices and how we protect your personal information."
        />
      </Helmet>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 prose dark:prose-invert prose-lg max-w-none">
            ...
            <p>
              At DesignKorv ("we," "our," or "us"), we respect your privacy and
            ...
            <p>
              ...
              our services, you acknowledge that you have read and understand
              this Privacy Policy.
            </p>
            ...
            <p>
              ...
              similar tracking technologies. For more information about our use
            ...
            <p>
              Our services are not directed to children under the age of 16, and
