  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about DesignKorv, our mission, and the team behind our premium digital fashion assets."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8">
              We're revolutionizing fashion design with premium digital assets
              that empower designers worldwide.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Founded in 2023, DesignKorv was born from a simple observation:
                fashion designers needed better digital resources.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Our team of industry veterans noticed that while the fashion
                world was rapidly evolving, the digital tools and assets
                available to designers weren't keeping pace.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Today, we're proud to provide the most comprehensive collection
                of premium digital fashion assets, used by leading designers and
                brands worldwide.
              </p>
              <Button
                variant="outline"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We maintain the highest standards for all our digital assets,
                ensuring you can create with confidence.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We believe in fostering a supportive network of fashion
                designers who inspire each other.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We're committed to promoting sustainable practices in the
            ...
            <div className="px-6 py-12 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between">
              <div className="md:max-w-2xl mb-8 md:mb-0">
                ...
                <p className="text-xl text-gray-900 dark:text-white mb-2">
                  Join thousands of fashion designers who trust DesignKorv for
