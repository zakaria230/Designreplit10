  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read DesignKorv's terms of service to understand your rights and responsibilities when using our platform."
        />
      </Helmet>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 prose dark:prose-invert prose-lg max-w-none">
            ...
            <p>
              Welcome to DesignKorv ("we," "our," or "us"). These Terms of
            ...
            <p>
              All purchases made through our Services are subject to these Terms
              and any additional terms presented at the time of purchase.
            </p>
            <p>
            ...
            <p>
              Payment must be made at the time of purchase. We accept various
              payment methods as indicated on our checkout page. All payments
              are processed securely through our payment processors.
            </p>

            <h2>4. Digital Content and Licensing</h2>
            <p>
              When you purchase digital content from DesignKorv, you are granted
              a non-exclusive, non-transferable license to use the content in
              accordance with the specific license terms associated with your
              purchase.
            </p>
            <p>
              Unless otherwise specified, our standard license allows you to use
              the purchased digital assets in personal and commercial design
              projects. However, you may not redistribute, resell, or sublicense
              the assets themselves as standalone files.
            </p>
            <p>
              For full details on licensing terms, please refer to the specific
              license agreement provided with each product.
            </p>

            <h2>5. User Content</h2>
            <p>
              You retain ownership of any content you submit, post, or display
              on or through our Services ("User Content"). By providing User
            ...
            <ul>
              ...
              <li>
                Engage in any activity that could harm or negatively affect our
                Services
              </li>
            </ul>
            ...
            <p>
              Our Services and all content and materials included on or in the
              Services, such as text, graphics, logos, button icons, images,
              audio clips, digital downloads, and data compilations, are the
              property of DesignKorv or its content suppliers and are protected
            ...
            <p>
              ...
              the laws of Sweden, without regard to its conflict of law
              provisions.
            </p>
